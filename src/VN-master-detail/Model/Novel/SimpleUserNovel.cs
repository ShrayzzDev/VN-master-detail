...
{
    public class SimpleUserNovel : BaseNovel
    {
        /// <summary>
        ...
        public SimpleUserNovel(string id, Image? image, string description, string title, float? average, SimpleProducer[] developpers, int added, int? voted, int? vote)
